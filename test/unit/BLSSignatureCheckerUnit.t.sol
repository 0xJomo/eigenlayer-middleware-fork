...
contract BLSSignatureCheckerUnitTests is BLSMockAVSDeployer {
    ...
    function testFuzz_setStaleStakesForbidden(bool newState) public {
        ...
        assertEq(
            blsSignatureChecker.staleStakesForbidden(),
            newState,
    ...
    function testFuzz_checkSignatures_SingleQuorum(
        ...
        bytes32[] memory pubkeyHashes = new bytes32[](
            nonSignerStakesAndSignature.nonSignerPubkeys.length
        );
        for (
            uint256 i = 0;
            i < nonSignerStakesAndSignature.nonSignerPubkeys.length;
            ++i
        ) {
            pubkeyHashes[i] = nonSignerStakesAndSignature
                .nonSignerPubkeys[i]
                .hashG1Point();
        }
        bytes32 expectedSignatoryRecordHash = keccak256(
            abi.encodePacked(referenceBlockNumber, pubkeyHashes)
        );
        ...
        assertTrue(
            quorumStakeTotals.signedStakeForQuorum[0] > 0,
    ...
    function test_checkSignatures_revert_inputLengthMismatch() public {
        ...
        IBLSSignatureChecker.NonSignerStakesAndSignature
            memory incorrectLengthInputs = IBLSSignatureChecker
                .NonSignerStakesAndSignature({
                    nonSignerQuorumBitmapIndices: nonSignerStakesAndSignature
                        .nonSignerQuorumBitmapIndices,
                    nonSignerPubkeys: nonSignerStakesAndSignature
                        .nonSignerPubkeys,
                    ...
                    quorumApkIndices: nonSignerStakesAndSignature
                        .quorumApkIndices,
                    totalStakeIndices: nonSignerStakesAndSignature
                        .totalStakeIndices,
                    nonSignerStakeIndices: nonSignerStakesAndSignature
        ...
        incorrectLengthInputs.quorumApks = nonSignerStakesAndSignature
            .quorumApks;
        // make one part of the input incorrect length
        ...
        // reset the input to correct values
        incorrectLengthInputs.quorumApkIndices = nonSignerStakesAndSignature
            .quorumApkIndices;
        // make one part of the input incorrect length
        ...
        // reset the input to correct values
        incorrectLengthInputs.totalStakeIndices = nonSignerStakesAndSignature
            .totalStakeIndices;
        // make one part of the input incorrect length
        ...
        incorrectLengthInputs
            ...
            .nonSignerStakeIndices;
        // make one part of the input incorrect length
        incorrectLengthInputs.nonSignerQuorumBitmapIndices = new uint32[](
            nonSignerStakesAndSignature.nonSignerPubkeys.length + 1
        );
        cheats.expectRevert(
    ...
    function test_checkSignatures_revert_referenceBlockNumberInFuture(
        ...
        (
            ,
            /*uint32 referenceBlockNumber*/ BLSSignatureChecker.NonSignerStakesAndSignature
                memory nonSignerStakesAndSignature
        ) = _registerSignatoriesAndGetNonSignerStakeAndSignatureRandom(
                pseudoRandomNumber,
                numNonSigners,
        ...
        uint32 invalidReferenceBlock = uint32(
            block.number + (pseudoRandomNumber % 20)
        );
        cheats.expectRevert(
    ...
    function test_checkSignatures_revert_staleStakes() public {
        ...
        for (uint256 i = 0; i < quorumNumbers.length; ++i) {
            uint256 quorumUpdateBlockNumber = registryCoordinator
                .quorumUpdateBlockNumber(uint8(quorumNumbers[i]));
        ...
        referenceBlockNumber =
            uint32(
                stalestUpdateBlock + delegationMock.minWithdrawalDelayBlocks()
            ) -
            1;
    ...
    function test_checkSignatures_revert_incorrectQuorumBitmapIndex(
        ...
        registryCoordinator._updateOperatorBitmapExternal(
            nonSignerStakesAndSignature.nonSignerPubkeys[0].hashG1Point(),
            uint192(quorumBitmap | 2)
        );
    ...
    function test_checkSignatures_revert_incorrectNonSignerStakeIndex(
        ...
        bytes32 nonSignerOperatorId = nonSignerStakesAndSignature
            .nonSignerPubkeys[0]
            .hashG1Point();
    ...
    function test_checkSignatures_revert_incorrectQuorumAPK(
        ...
        nonSignerStakesAndSignature.quorumApks[0] = nonSignerStakesAndSignature
            .quorumApks[0]
            .negate();
    ...
    function test_checkSignatures_revert_incorrectSignature(
        ...
        nonSignerStakesAndSignature.sigma = nonSignerStakesAndSignature
            .sigma
            .negate();
